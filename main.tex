...
\begin{figure}[H]
  ...
  \includegraphics[width=0.6\linewidth]{images/Figure 4.4.1 Project structure.png}
\end{figure}

\begin{figure}[H]
  \centering
  \caption{Figure 4.4.2 Normal user side app structure}
  \includegraphics[width=0.6\linewidth]{images/Figure 4.4.2 Normal user side app structure.png}
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.6\linewidth]{images/Figure 4.4.3 Custom user model.png}
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.6\linewidth]{images/Figure 4.4.4 Project model.png}
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.6\linewidth]{images/Figure 4.4.10 Filtering logic in the view.png}
\end{figure}
...
\includegraphics[width=0.6\textwidth]{images/Figure 4.5.1 Django Models Definition.png}
\end{figure}
...
\includegraphics[width=0.6\textwidth]{images/Figure 4.7.3 User-based query filtering in viewProjects view.png}
