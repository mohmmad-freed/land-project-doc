...
The machine learning model was tested to evaluate its predictive performance and reliability. Figure 5.4.1 shows the results of the cross-validation performance test, providing the mean MAE across folds. Figure 5.4.2 presents the performance evaluation using a train-test split, illustrating the model’s accuracy on unseen data. Figure 5.4.3 visualizes the predicted prices versus residuals, highlighting the distribution of prediction errors. Figure 5.4.4 displays the trained decision tree, showing the main splits and feature importance.
