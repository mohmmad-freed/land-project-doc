...
The dataset used for training was collected from real land parcel evaluations provided by a professional land appraiser. 

\begin{figure}[H]
\centering
\captionsetup{position=top}
\includegraphics[width=0.9\textwidth]{images/dataformat.png}
