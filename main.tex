...
The dataset used for training was collected from real land parcel evaluations provided by a professional land appraiser.  About 150 land parcel samples were collected, each with 38 columns (features), the most important features for training being: land\_type, Area, Neighborhood, political\_classification, view\_quality, area\_m2, land\_use\_residential, land\_use\_ commercial, actual\_price\_per\_m2, ownership\_document\_type, ANIMAL\_FARMS, NOISY\_ FACILITIES, FACTORIES\_NEARBY, municipality\_facility, police\_facility, parcel\_shape, road\_status1, width\_m, Sewage, water, electricity, land\_use\_agricultural, land\_use\_industrial.
